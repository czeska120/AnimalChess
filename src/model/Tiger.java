...
public class Tiger extends Piece
{
     ...
     */
    public Tiger(String n, int posX, int posY, boolean p, LinkedList<Piece> ps, int r, Color color)
    {
    ...
    /**
     * called whenever Tiger is not inside of Trap.
     */
    ...
    /**
     * Overridden validator to satisfy Tiger conditions.
     *
    ...
    /**
     * Checks if there is a Mouse in jump path of Tiger.
     *
     * @param nextX - next x coordinate
     * @param nextY - next y coordinate
